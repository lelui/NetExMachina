...
optim = t.optim.Adam(netexmachina.parameters(), lr=0.0001)
patience = 5
AshKetchum = Trainer(netexmachina, loss_crit, optim, train_dl=train_loader, val_test_dl=test_loader, cuda=True, early_stopping_patience=100)
