...
patience = 5
AshKetchum = Trainer(netexmachina, loss_crit, optim, train_dl=train_loader, val_test_dl=test_loader, cuda=False, early_stopping_patience=5)
# go, go, go... call fit on trainer
res = AshKetchum.fit(2)#TODO
